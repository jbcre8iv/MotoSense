# Supabase Setup Guide for MotoSense
...
## Step 3: Configure MotoSense

1. Create a file named `.env` in your MotoSense root directory:
   ```bash
   # In your terminal:
   touch .env
   ```
...
- Or drop tables and re-run if you need fresh start

### Can't see Realtime toggle
- Make sure you're on the **Replication** tab
- If not there, realtime might already be enabled

---

## Migration 2: Competitions & Races (Run Later)

When ready to add competitions, run this SQL:

```sql
-- Will be added in Phase 2
-- competitions, races, predictions, group_competitions tables
```
